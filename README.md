...
<table><tr>
    ...
    <td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6643&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/zipfile2-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `zipfile2` can be installed with:

```
conda install zipfile2
```

It is possible to list all of the versions of `zipfile2` available on your platform with:
